...
canonical: "https://seqera.io/blog/migration-from-biocontainers-to-seqera-containers-part-2"
...
:::tip
{/* {.fa-hourglass-clock title="Too Long; Didn't Read"} */}
...
{/* {.fa-code title="nextflow.config" collapse} */}
::::info
