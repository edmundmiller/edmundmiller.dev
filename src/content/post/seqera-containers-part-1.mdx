...
canonical: "https://seqera.io/blog/migration-from-biocontainers-to-seqera-containers-part-1"
...
:::info
{/* {.fa-calendar-lines-pen title="Timeline" collapse} */}
...
:::info
{/* {.fa-list-check title="Feature comparison"} */}
...
:::tip
{/* {title="How to make a mulled BioContainer"} */}
...
:::info
{/* TODO {title="Example Wave build details page" collapse} */}
