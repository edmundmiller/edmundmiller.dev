...
{/* <Image class="d-block w-25 float-end mb-3 ms-3 rounded shadow" src={butwhy} alt="Photo by Simone Secci on Unsplash." /> */}
...
{/* <YouTube id="https://www.youtube.com/watch?v=SE6ZCvh1ThQ" poster="http://i3.ytimg.com/vi/SE6ZCvh1ThQ/hqdefault.jpg" class="d-block w-50 float-end mb-3 ms-3 rounded shadow" /> */}
...
{/* <Image class="d-block w-25 clearfix float-end mb-3 ms-3 rounded shadow" src={mulled} alt="Photo by Hannah Pemberton on Unsplash." /> */}
...
{/* <Image class="d-block w-25 float-end mb-3 ms-3 rounded shadow" src={disks} alt="Photo by Behnam Norouzi on Unsplash." /> */}
...
{/* <Image class="d-block float-end mb-3 ms-3 rounded shadow" src={wave_logs} alt="Screenshot of a Wave container build details page." /> */}

Wave build details page for the MultiQC v1.24.1 image: `community.wave.seqera.io/library/multiqc:1.24.1--789bc3917c8666da`

The final part is the hash - from this we can infer the Wave Build ID and retrieve the build details: [Wave build details for 789bc3917c8666da_1](https://wave.seqera.io/view/builds/789bc3917c8666da_1)
...
{/* <Image class="d-block w-100 float-end mb-3 ms-3 rounded shadow" src={leaves} alt="Photo by Providence Doucet on Unsplash." /> */}
